                    ...
                    <div class="site-card">
                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                ...
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Widget Contact Title') }}<i
                                            data-lucide="info" data-bs-toggle="tooltip" title=""
                                ...
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Contact Phone Number') }}<i
                                                data-lucide="info" data-bs-toggle="tooltip" title=""
                                                data-bs-original-title="Change the Contact Number"></i></label>
                                    <div class="col-sm-9">
                                        <input type="text" name="contact_phone_number" class="box-input"
                                            ...
                                            @if($key == 'en')
                                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="site-input-groups">
                                                        ...
                                                        <input type="text" name="footer_button_icon" class="box-input"
                                                               value="{{ $data->footer_button_icon }}">
                                                    </div>
                                                </div>
                                            @endif
                                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="site-input-groups">
                                                    ...
                                                    <input type="text" name="footer_button_level" class="box-input"
                                                           value="{{ $data->footer_button_level }}">
                                                </div>
                                            </div>
                                            @if($key == 'en')
                                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="site-input-groups">
                                                        ...
                                                        <div class="site-input-groups">
                                                            <div class="site-input-groups">
                                                                <input type="text" name="footer_button_url" class="box-input"
                                                                       value="{{ $data->footer_button_url }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-2 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="site-input-groups">
                                                        ...
                                                        <div class="site-input-groups">
                                                            <select name="footer_button_target" class="form-select">
                                                                <option @if($data->footer_button_target == '_self') selected
                                                                        @endif value="_self">{{ __('Same Tab') }}</option>
                                                                <option @if($data->footer_button_target == '_blank') selected
                                ...
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Community Title') }}</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="community_title" class="box-input"
                                               value="{{ $data->community_title }}">
                                    </div>
                                </div>

                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Community Description') }}</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="community_description" class="box-input"
