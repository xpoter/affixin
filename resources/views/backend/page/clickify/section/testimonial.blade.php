...
@section('content')
                    ...
                    <div class="site-card">
                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                ...
                                <div class="site-input-groups row">
                                    <label for=""
                                           class="col-sm-3 col-label">{{ __('Title') }}</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="site-input-groups row">
                                    <label for=""
                                           class="col-sm-3 col-label">{{ __('Description') }}</label>
                                    <div class="col-sm-9">
    ...
    <!-- Modal for Edit -->
    @include('backend.page.'.site_theme().'.section.include.__edit_testimonial')
    <!-- Modal for Edit  End-->
