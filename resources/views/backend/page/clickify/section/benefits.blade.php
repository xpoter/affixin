...
@section('content')
                                    ...
                                    <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                        ...
                                        <div class="site-input-groups row">
                                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-label">
                                                {{ __('Benefits Left Image') }} <small>(567x596)</small>
                                            </div>
                                            <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12">
                                                <div class="wrap-custom-file">
                                                    <input type="file" name="left_img" id="heroRightImg"
                                                           accept=".gif, .jpg, .png"/>
                                                    <label for="heroRightImg" id="left_img" @if($data->left_img) class="file-ok"  style="background-image: url({{ asset($data->left_img) }})" @endif>
    ...
    <!-- Modal for Add New  -->
    @include('backend.page.'.site_theme().'.section.include.__add_new_benefit')
    <!-- Modal for Add New Benefit End -->

    <!-- Modal for Edit -->
    @include('backend.page.'.site_theme().'.section.include.__edit_benefit')
    <!-- Modal for Edit  End-->

    <!-- Modal for Delete  -->
    @include('backend.page.'.site_theme().'.section.include.__delete_benefit')
