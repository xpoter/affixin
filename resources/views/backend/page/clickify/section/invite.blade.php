                            ...
                            <div class="site-card">
                                ...
                                <div class="site-card-body">
                                    <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                        ...
                                        <div class="site-input-groups row">
                                            <label for=""
                                                   class="col-sm-3 col-label">{{ __('Invite Title') }}</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="site-input-groups row">
                                            <label for=""
                                                   class="col-sm-3 col-label">{{ __('Invite Description') }}</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="description" class="box-input"
                                            ...
                                            <div class="site-input-groups row">
                                                ...
                                                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12">
                                                    <div class="wrap-custom-file">
                                                        <input type="file" name="right_img" id="InviteLeftImg"
                                                               accept=".gif, .jpg, .png"/>
                                                        <label for="InviteLeftImg" id="InviteLeftImg"
                                                               @if($data->right_img) class="file-ok"
