                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="title-content">
                            <h2 class="title">{{ __('Plans Page') }}</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="site-card">
                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.page.update') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="page_code" value="plans">
                                <input type="hidden" name="page_locale" value="{{$key}}">
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Page Title') }}
                                        <i data-lucide="info" data-bs-toggle="tooltip" data-bs-original-title="Page Title will show on Breadcrumb"></i>
                                    </label>
                                    <div class="col-sm-9">
                                ...
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Plan Choose Title') }}</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="plan_choose_title" class="box-input" value="{{ $data->plan_choose_title }}">
                                    </div>
                                </div>
