                        ...
                        <form action="{{ route('admin.ads.update', $ads->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xxl-8">
                                        <div class="site-input-groups" id="typeValueField">
                                            <div id="link" class="{{ old('type', $ads->type->value) == 'link' ? '' : 'd-none' }}">
                                            ...
                                            <div id="youtube" class="{{ old('type', $ads->type->value) == 'youtube' ? '' : 'd-none' }}">
                                            ...
                                            <div id="script" class="{{ old('type', $ads->type->value) == 'script' ? '' : 'd-none' }}">
                                            ...
                                            <div id="image" class="{{ old('type', $ads->type->value) == 'image' ? '' : 'd-none' }}">
                                                <label class="box-input-label" for="">{{ __('Image') }}</label>
                                                @if($ads->type->value == 'image' && $ads->value)
                                                    <div class="mb-2">
                                                        <img src="{{ asset($ads->value) }}" alt="Current Image" style="max-width: 200px;">
                                                    </div>
                                                @endif
                                ...
                                <div class="col-xxl-12">
                                    ...
                                    <div id="scheduleList">
                                        @if($ads->schedules)
                                            @foreach($ads->schedules as $key => $schedule)
                                                <div class="row schedule-item">
                                                    <div class="col-xxl-4">
                                                        <div class="site-input-groups">
                                                            <label class="box-input-label" for="">{{ __('Days') }}</label>
                                                            <select name="schedules[{{ $key }}][day]" class="form-select" required>
                                                    ...
                                                    <div class="col-xxl-3">
                                                        <div class="site-input-groups">
                                                            ...
                                                            <input type="time" name="schedules[{{ $key }}][start_time]" class="box-input mb-0" value="{{ $schedule['start_time'] }}" required/>
                                                        </div>
                                                    </div>
                                                    <div class="col-xxl-3">
                                                        <div class="site-input-groups">
                                                            <label for="" class="box-input-label">{{ __('End Time') }}</label>
                                                            <input type="time" name="schedules[{{ $key }}][end_time]" class="box-input mb-0" value="{{ $schedule['end_time'] }}" required/>
                                                        </div>
                                                    </div>
                                                    <div class="col-xxl-2">
...
@section('script')
    <script>
        (function ($) {
            ...
            // Set counter based on existing schedules
            var counter = {{ $ads->schedules ? count($ads->schedules) : 0 }};
