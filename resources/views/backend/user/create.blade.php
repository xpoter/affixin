                        ...
                        <div class="site-card">
                            ...
                            <div class="site-card-body">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                        <div class="site-input-groups">
                                            <label for="" class="box-input-label">{{ __('Referral Code:') }}</label>
                                            <input type="text" name="invite" class="box-input mb-0" value="{{ old('invite') }}" required/>
                                        </div>
                                    </div>
                                    @endif
                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                                ...
                                                @foreach(json_decode($kyc->fields, true) as $key => $field)
                                                    ...
                                                    <div class="site-input-groups">
                                                        <label for="" class="box-input-label">{{ $field['name'] }} @if($field['validation'] == 'required') <span class="text text-danger">*</span>
                                                            @endif</label>
                                                        <textarea name="kyc_credential[{{ $kyc->id }}][{{ $field['name'] }}]" class="form-textarea mb-0" @required($field['validation'] == 'required')></textarea>
                                                    </div>
                                                    @else
                                                    <div class="site-input-groups">
                                                        <label for="" class="box-input-label">{{ $field['name'] }} @if($field['validation'] == 'required') <span class="text text-danger">*</span>
