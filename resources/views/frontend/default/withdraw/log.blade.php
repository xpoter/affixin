                ...
                <div class="fund-transfer-history">
                    <div class="site-card-header">
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
                            ...
                            <a href="{{ route('user.withdraw.view') }}" class="site-btn primary-btn"><i class="icon-repeat-circle"></i>{{ __('Withdraw') }}</a>
                        </div>
                    </div>
                                            ...
                                            <div class="description">
                                                ...
                                                <div class="content">
                                                    <h3 class="title">
                                                        ...
                                                        <button type="button" class="message-icon" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="{{ $history->approval_cause }}">
