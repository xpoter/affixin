        ...
        <div class="auth-wrapper">
            <div class="contents-inner">
                    ...
                    <div class="auth-form-wrapper">
                        ...
                        <form action="{{ route('register.now') }}" method="POST">
                            ...
                            <div class="single-input has-left-icon">
                                <label class="input-label" for="">{{ __('First Name') }}<span
                                        class="text-danger">*</span></label>
                                <div class="input-field">
                                    <input type="text" class="box-input name-input" name="first_name"
                            ...
                            <div class="single-input has-left-icon">
                                <label class="input-label" for="">{{ __('Last Name') }}<span
                                        class="text-danger">*</span></label>
                                <div class="input-field">
                                    <input type="text" class="box-input name-input" name="last_name"
                            ...
                            @if (getPageSetting('username_show'))
                                <div class="single-input has-left-icon">
                                    <label class="input-label" for="">{{ __('Username') }}@if (getPageSetting('username_validation'))
                                            <span class="text-danger">*</span>
                                        @endif
                                    </label>
                                    <div class="input-field">
                                        <input type="text" class="box-input name-input" name="username"
                            ...
                            <div class="single-input has-left-icon">
                                <label class="input-label" for="">{{ __('Email Address') }}<span
                                        class="text-danger">*</span></label>
                                <div class="input-field">
                                    <input type="email" class="box-input email-input" name="email"
                            ...
                            @if (getPageSetting('country_show'))
                                <div class="single-input mb-3">
                                    <label class="input-label" for="">{{ __('Country') }} @if (getPageSetting('country_validation'))
                                            <span class="text-danger">*</span>
                                        @endif
                                    </label>
                            ...
                            @if (getPageSetting('phone_show'))
                                <div class="single-input mb-3">
                                    <label class="input-label" for="">{{ __('Phone Number') }} @if (getPageSetting('country_validation'))
                                            <span class="text-danger">*</span>
                                        @endif
                                    </label>
                            ...
                            @if (getPageSetting('referral_code_show'))
                                <div class="single-input mb-3">
                                    <label class="input-label" for="">{{ __('Referral Code') }} @if (getPageSetting('referral_code_validation'))
                                            <span class="text-danger">*</span>
                                        @endif
                                    </label>
                                    <div class="input-field">
                            ...
                            @if (getPageSetting('gender_show'))
                                <div class="single-input mb-3">
                                    <label class="input-label" for="">{{ __('Gender') }} @if (getPageSetting('gender_validation'))
                                            <span class="text-danger">*</span>
                                        @endif
                                    </label>
                            ...
                            <div class="single-input has-right-icon has-left-icon">
                                <label class="input-label" for="">{{ __('Confirm Password') }}<span
                                        class="text-danger">*</span></label>
                                <div class="input-field">
                                    <input type="password" name="password_confirmation" class="box-input password-input"
                                        required>
                                    <div class="password">
                                        <img src="{{ asset('frontend/default/images/icons/eye-off.svg') }}"
                                            class="password-hide-show eyeicon" alt="">
                            ...
                            <div class="inputs">
                                <button type="submit"
                                    class="site-btn primary-btn w-100">{{ __('Create account') }}</button>
                            </div>
                        </form>
                    </div>
                ...
                <div class="terms-user">
                    <p>{{ __('By clicking “Create account”, you agree to our') }} <a class="link"
                            href="{{ url('/terms-and-conditions') }}">{{ __('Terms and Conditions') }}.</a></p>
                </div>
            </div>
        </div>
    </section>
