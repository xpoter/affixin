                        ...
                        <div class="header-btn-wrap d-none d-sm-block">
                            ...
                            <div class="language-box">
                                <div class="header-lang-item header-lang">
                                    <span class="header-lang-toggle" id="header-lang-toggle"><i class="fa-regular fa-globe"></i> <span class="lang-text">{{ localeName() }}</span></span>
                                    <ul id="language-list" class="hidden">
                                        @foreach(\App\Models\Language::where('status',true)->get() as $lang)
                                        <li>
                                            <a href="{{ route('language-update',['name'=> $lang->locale]) }}">{{ $lang->name }} <span class="icon"></span></a>
                                        </li>
                                        @endforeach
                                    </ul>
                                </div>
