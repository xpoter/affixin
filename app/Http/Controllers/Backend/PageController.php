...
class PageController extends Controller
{
    ...
    public function edit($name)
    {
        ...
        $landingSections = LandingPage::where('status', true)->where('code', '!=', 'footer')->where('theme', site_theme())->where('locale', 'en')->when(isset($engData['section_id']) && json_decode($engData['section_id']), function ($query) use ($commaIds) {
        ...
        return view('backend.page.'.site_theme().'.'.$name, compact('status', 'landingSections', 'slug', 'groupData', 'languages'));
    ...
    public function update(Request $request)
    {
        ...
        $engPage = Page::where('code', $pageCode)->where('theme', site_theme())->where('locale', '=', 'en')->first();
