    ...
    'ads' => [
        ...
        'elements' => [
            [
                'type' => 'checkbox', // input fields type
                'data' => 'boolean', // data type, string, int, boolean
                'name' => 'ads_bonus_system', // unique name for field
                'label' => 'Ads Bonus', // you know what label it is
                'rules' => 'required', // validation rule of laravel
                'value' => '0', // default value if you want
            ],
            [
                ...
                'name' => 'ads_limit_free_user', // unique name for field
                'label' => 'Ads Limit for Free User', // you know what label it is
            ...
            [
                ...
                'label' => 'Referral Level for Free User', // you know what label it is
                'rules' => 'required|numeric', // validation rule of laravel
                'value' => '1', // default value if you want
            ],
            [
                'type' => 'checkbox', // input fields type
                'data' => 'double', // data type, string, int, boolean
                'name' => 'withdraw_limit_free_user', // unique name for field
                'label' => 'Withdraw Limit for Free User', // you know what label it is
                'rules' => 'required|numeric', // validation rule of laravel
            ...
            [
                'type' => 'text', // input fields type
                'data' => 'double', // data type, string, int, boolean
                'name' => 'ads_bonus_delay_hours', // unique name for field
                'label' => 'Bonus Delay Days', // you know what label it is
                'rules' => 'required|numeric', // validation rule of laravel
    ...
    'kyc' => [
        ...
        'elements' => [
            ...
            [
                'type' => 'checkbox', // input fields type
                'data' => 'boolean', // data type, string, int, boolean
                'name' => 'kyc_ads', // unique name for field
                'label' => 'Ads', // you know what label it is
                'rules' => 'required', // validation rule of laravel
                'value' => '0', // default value if you want
            ],
        ],
